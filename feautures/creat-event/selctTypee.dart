...
import 'package:responsive/cubit/homePage/home_page_cubit.dart';
   ...
   List<Map> Type = [
  {'name': 'puplic', 'iconPath': 'lib/images/public.png'},
  {'name': 'private', 'iconPath': 'lib/images/private.png'},
  
];

class SelectTypee extends StatelessWidget {
  @override
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  {
                   await context.read<HomePageCubit>().getCategories();
              ...
              padding: EdgeInsets.symmetric(vertical: 35),
               child: Center(
                child: Column(children: [
                  Imagee(name: Type[0]['name'], icon: Type[0]['iconPath'], onTap: ()async { await context.read<createCubit>().select_type(Type[0]['name']); }, ),
                   SizedBox(height: 80,),
                  Imagee(name: Type[1]['name'], icon: Type[1]['iconPath'], onTap: ()async { await context.read<createCubit>().select_type(Type[1]['name']); }, ),
                ]),
               ),
             ))
          ],
